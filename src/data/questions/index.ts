...
/** 面试类型预设 */
export const interviewTypes: Record<
  string,
  {
    label: string
    description: string
...
export interface SelectQuestionsConfig {
...
export function selectQuestions({
  ...
  questionCount,
  difficulty = 'all',
}: SelectQuestionsConfig): InterviewQuestion[] {
  ...
  function pickRandom(arr: InterviewQuestion[], n: number): InterviewQuestion[] {
